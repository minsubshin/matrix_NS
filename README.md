...
The EEG database used for the real data analysis in Section 5 is available at UCI Machine Learning Repository (see the source below for the link). To prepare the data, please follow these steps:
