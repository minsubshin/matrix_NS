...
To execute the code, please download all the included files into a single directory and run the R script named after the corresponding figure or table from the paper.
